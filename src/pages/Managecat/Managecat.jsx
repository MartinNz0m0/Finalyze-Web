...
import { DeleteSuccessAlert, FormSubmitSuccessAlert } from "../../components/Alerts";
import { HashLoader } from "react-spinners";
import './Managecat.scss'
          ...
          <Modal.Body>
            <div className="d-flex flex-column m-3 align-items-center">
              ...
              <div className="d-flex flex-row-reverse">
                ...
                <Button size='sm' variant="secondary mx-2" className="rounded" onClick={() => {
                  setReadonly(false)
                  ref.current.focus()
                }}>Edit</Button>
